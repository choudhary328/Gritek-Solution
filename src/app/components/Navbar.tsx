      ...
      <div className="hidden lg:flex w-full bg-[#21362e] text-white text-[13px] font-medium py-3 px-4 sm:px-6 lg:px-8 justify-between items-center relative overflow-hidden">
        <div className="flex gap-8 z-10 ml-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>griteksolution.offical@gmail.com</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center gap-2">
              <div className="flex">
                ...
                <div className="w-2.5 h-5 bg-[#21362e] rounded-sm"></div>
              </div>
              <span className="text-xl font-extrabold text-[#21362e] tracking-tight">
                GRITEK SOLUTION
              </span>
            </Link>
            ...
            <div className="hidden md:block">
              <Link to="/contact">
                <button className="bg-[#21362e] text-[#b8ea27] text-[15px] font-bold px-7 py-3 rounded-full hover:bg-opacity-90 transition-all duration-300 shadow-md">
                  Get Free Consulting
                </button>
              </Link>
            </div>
            ...
            <div className="md:hidden mt-4 py-4 border-t border-gray-100 bg-white rounded-b-2xl shadow-lg absolute left-0 right-0 px-4">
              ...
              <div className="px-4 pt-4 mt-2 border-t border-gray-100">
                <Link to="/contact" className="block" onClick={() => setIsMobileMenuOpen(false)}>
                  <button className="bg-[#21362e] text-[#b8ea27] text-sm font-bold px-6 py-3 rounded-full w-full hover:bg-opacity-90 shadow-md">
                    Get Free Consulting
                  </button>
                </Link>
              </div>
