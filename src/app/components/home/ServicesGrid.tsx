...
import { Code2, ShoppingCart, Smartphone, TrendingUp, PenTool, GraduationCap, ArrowRight } from 'lucide-react';

const services = [
  {
    icon: Code2,
    title: 'Web Development',
    description: 'Custom, fast, SEO-optimized websites built with modern frameworks.',
    color: '#b8ea27',
  },
  {
    icon: ShoppingCart,
    title: 'E-Commerce Development',
    description: 'Feature-rich online stores with payment gateway and inventory management.',
    color: '#b8ea27',
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    description: 'SEO, social media and paid ads to grow your online presence.',
    color: '#b8ea27',
  },
  {
    icon: PenTool,
    title: 'Graphic Design',
    description: 'Brand identity, UI design, and creative visual communication.',
    color: '#b8ea27',
  },
  {
    icon: GraduationCap,
    title: 'Student Projects',
    description: 'Complete college and university project assistance for IT students.',
    color: '#b8ea27',
  },
];
