...
const staticTestimonials = [
  {
    ...
    rating: 5,
    review: 'Gritek Solution delivered our e-commerce platform ahead of schedule. Their attention to detail and professionalism is outstanding. Highly recommended!',
    verified: true,
  },
  {
    name: 'Priya Sharma',
    ...
    rating: 5,
    review: 'Working with Gritek was a fantastic experience. They understood our vision and created a beautiful, functional website that increased our sales by 40%.',
    verified: true,
  },
  {
    name: 'Amit Patel',
    ...
    rating: 5,
    review: 'The mobile app they developed for us is phenomenal. Clean code, intuitive UI, and excellent support. Best IT agency in Gujarat!',
    verified: true,
  },
  {
    name: 'Sneha Desai',
    ...
    rating: 5,
    review: 'From consultation to launch, the entire process was smooth. They are responsive, creative, and deliver quality work. Will work with them again!',
    verified: true,
  },
];
...
export function Testimonials() {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/api/reviews/approved')
      .then(res => res.json())
      .then(data => setDynamicReviews(data))
