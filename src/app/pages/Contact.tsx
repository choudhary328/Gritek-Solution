...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Send email via EmailJS to your personal email
      const templateParams = {
        to_email: 'griteksolution.offical@gmail.com', // Change to your receiving email if needed
      ...
      // Ensure you replace these with your actual EmailJS IDs from https://dashboard.emailjs.com/
      ...
      if (serviceId !== 'YOUR_SERVICE_ID') {
        await emailjs.send(serviceId, templateId, templateParams, publicKey);
         ...
         console.warn("EmailJS skipped: Please configure VITE_EMAILJS_SERVICE_ID in your .env file.");
      }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-[#21362e]/80 mb-6 sm:mb-10 max-w-xl leading-relaxed">
                Whether you have a question, want to start a project, or simply want to connect, our team is ready to listen and help you achieve your goals.
              </p>
            ...
            <div className="relative w-full mt-10 lg:mt-0 h-[320px] sm:h-[400px] lg:h-[470px]">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#21362e]/55 text-[11px]">+91 77780 20756</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#21362e]/55 text-[11px]">ritikakumawat2028@gmail.com</p>
                </div>
              </motion.div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#21362e]/70">+91 77780 20756</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#21362e]/70">ritikakumawat2028@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#21362e]/70">Baben, Bardoli, Surat – Gujarat, India</p>
                  </div>
                </div>
