...
const projects = [
  ...
  },
  {
    ...
    demoLink: 'https://demo-corp.example.com',
  },
  {
  ...
  },
  {
    ...
    demoLink: 'https://demo-restaurant.example.com',
  },
  {
    title: 'Fashion Store',
    category: 'E-Commerce',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                <Link to="/contact">
                  <button className="bg-[#b8ea27] text-[#21362e] px-6 py-3 rounded-xl font-bold text-base hover:shadow-[0_0_20px_rgba(184,234,39,0.5)] transition-all duration-300 transform hover:-translate-y-1">
                    Start Your Project
                  </button>
                </Link>
                <Link to="/services">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {categories.map((category) => (
                <button
                  ...
                  className={`px-4 sm:px-6 py-2 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-300 flex items-center gap-2 ${
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <p className="text-[#21362e]/60 text-sm mb-6 line-clamp-3 flex-1">
                    A comprehensive {project.category.toLowerCase()} solution tailored to modern business requirements, featuring advanced functionality, clean design, and a seamless user experience prioritizing performance and scalability.
                  </p>
            ...
            >
              ...
              <div className="p-6 sm:p-8 md:w-1/2 overflow-y-auto">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed text-sm">
                  This {selectedProject.category.toLowerCase()} project builds upon modern architectural principles to deliver an outstanding digital presence. From its responsive design to its rich feature set, it sets a high bar for user experience.
                </p>
