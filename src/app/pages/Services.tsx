...
const services = [
  {
    ...
    description: 'Modern, fast, SEO-friendly websites and web applications.',
    accent: '#21362e',
    features: ['Custom UI/UX Design', 'CMS Integration', 'SEO Optimization', 'Performance Tuning', 'Responsive Layout'],
  ...
  },
  {
    ...
    description: 'Full-featured online stores with seamless checkout and payment.',
    accent: '#b8ea27',
  ...
  },
  {
    ...
    accent: '#b8ea27',
    features: ['Cross-platform', 'Push Notifications', 'Offline Support', 'API Integration', 'App Store Submission'],
  ...
  },
  {
    ...
    description: 'Data-driven marketing strategies to grow your reach.',
    accent: '#21362e',
        ...
        if (Array.isArray(data)) {
          const formatted = data.map(s => {
            ...
            return {
              ...s,
              icon: IconComponent,
              image: `http://localhost:5000${s.image}`,
            };
          });
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <p className="text-lg text-[#21362e]/80 leading-relaxed">
                    Create a powerful online presence with our custom {service.title.toLowerCase()} services. We build fast, secure, and scalable solutions that drive results and engage your audience.
                  </p>
                  <p className="text-[#21362e]/70 leading-relaxed">
                    Our comprehensive package includes everything you need to launch and maintain successful operations, from initial discovery to ongoing support and {service.features[0].toLowerCase()}.
                  </p>
